...
const TestimonialData = [
  {
    ...
    text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ut necessitatibus, quidem aut modi cumque eum recusandae ipsa amet error deserunt esse sint.",
    delay: 0.2,
  },
  {
    id: 2,
  ...
  return (
    <div className=" py-14">
      ...
      <div className="space-y-4 text-center max-w-[550px] mx-auto mb-8">
        ...
        >
          Bring your dream home to life with one-on-one design help &hand picked
          products
        </motion.p>
      </div>
      {/* testmonial cards */}
          ...
          {TestimonialData.map((card) => {
            return (
              <motion.div
                ...
                whileInView="animate"
                key={card.id}
                className="border-[1px] border-gray-500 p-5 py-10 text-white group hover:bg-white hover:text-black duration-300"
              >
                {/* upper section */}
