...
import { SlideUp } from "../../Components/animation/animation";

const Hero = () => {
  return (
    <>
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 md:min-h-[650px] gap-10">
          {/* text section */}
          <div className="flex flex-col justify-center gap-5 md:pr-8 lg:pr-52 text-center md:text-left pt-20 md:pt-0 px-10">
            <motion.h1
          ...
          <div className="flex flex-col items-center justify-center">
            <motion.img
              ...
              src={HeroPng}
              alt=""
              className="w-[80%] md:w-[600px] object-cover md:scale-125"
            />
          </div>
        </div>
      </div>
